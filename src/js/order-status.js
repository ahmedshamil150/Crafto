  ...
  resultEl.innerHTML = `
    <div class="order-summary-box">
      ...
      ${canCancel(order.status) ? `
        <button type="button" id="cancel-order-btn" class="button" style="background:#c62828;margin-top:1.25rem;width:100%;">
          Cancel Order
        </button>
      ` : ''}
      ${canReturn(order.status) ? `
        <button type="button" id="return-order-btn" class="button button-outline" style="margin-top:1rem;width:100%;">
          Request Return
        </button>
      ` : ''}
    </div>
